...
public class BlockDisplay extends JComponent implements KeyListener
{
    ...
    public void paintComponent(Graphics g)
    {
        ...
        g.drawString("Score: "+Tetris.getScore(), 0, BLOCKSIZE * board.getNumRows()+20);
        g.drawLine(0,BLOCKSIZE * board.getNumRows(), BLOCKSIZE * board.getNumCols(), BLOCKSIZE * board.getNumRows());
        g.drawString("Level: "+Tetris.getLevel(), (BLOCKSIZE * board.getNumCols())/2, BLOCKSIZE * board.getNumRows()+20);
    }
